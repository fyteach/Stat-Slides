...
- The **error of a prediction** also known as **residual** is
  $$\text{Error}=\text{Residual}=\text{Observed}-\text{Predicted}=y-\hat{y}.$$

- A prediction beyond the range of the data is called **extrapolation**.

::: {.center}
![A image of positive and negative residuals](Figures/residual.png)  
