...
1. Histograms are usually used for continuous data. For discrete numerical variables, using a bar chart or a histogram depends on context.
...
The following data set show the mpg (mile per gallon) of $`r SampleSize<-30`30$ cars.  Construct a frequency table and frequency histogram for the data set using $`r Nbins<-ceiling(2*SampleSize^(1/3)); Nbins`$ bins. What can be concluded from the histogram?
