...
output:
  markdown::html_format:
    keep_md: true
    meta:
      css: [default, slides, "Assets/css/custom.css", "@npm/@xiee/utils/css/key-buttons.min.css,heading-anchor.min.css"]
      js: [slides, "@npm/@xiee/utils/js/key-buttons.min.js,external-link.min.js,heading-anchor.min.js", "Assets/js/lastupdated.js", "Assets/js/mathjax-font.js"]
    options:
...
## Confidence Intervals with Known Population SD
...
- When we use the estimated standard error $s / \sqrt{n}$ to build a confidence interval, the <span class="red">normal distribution may OT</span> be appropriate for calculating the critical value.
...
::: {.center}
![t-curves](Figures/t-curves.svg){width="45%"}
:::
...
## Confidence Intervals for a Mean with <span class="red">Unknown</span> Population SD
...
Since the sample size is 16, the degree of freedom is <span class="red">df=15</span>.
...
- Population is <span class="red">approximately ormally</span> distributed.
...
- Population distribution unknown, but .gold[sample size is large enough], i.e. $n>30$.
  ...
  - the population standard deviation $\sigma$ is <span class="purple">*unknown*</span>: either one can be used but the $t$-<span class="purple">*distribution*</span> is more accurate.

- **<span class="red">Warning</span>** Population distribution unknown and the <span class="red">sample size is small, either</span> the $t$-distribution nor the normal distribution is reliable.
...
# Lab Instructions in Excel {.unnumbered}
