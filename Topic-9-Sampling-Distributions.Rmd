...
- When working with categorical variables, we often study the proportion of a data set.
  ...
  **Example:** Consider the following data set
  .center[<span class="red">[1]</span>, 0, <span class="red">[1]</span>, <span class="red">[1]</span>, 0, 0, <span class="red">[1]</span>, 0, <span class="red">[1]</span>, <span class="red">[1]</span>]
  Find proportion of <span class="red">[red numbers]</span> and the mean of the data set.
