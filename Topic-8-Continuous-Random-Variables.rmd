...
| Z    | 0.04   | 0.05   | 0.06   |
| ---- | ------ | ------ | ------ |
| 1.2  | 0.8925 | <span class="red">0.8944</span> | 0.8962 |
:::
::::

The probability is $P(X>67)=1-P(X<67)$. To calculate $P(X<67)$, one way is to use the standard normal distribution table. First find the $Z$-score is $z=\frac{67-62}{4}=1.25$. Then $P(Z<1.25)\approx 0.8944$.

Another way is to use the Excel function `NORM.DIST(67, 62, 4, TRUE)` which gives $P(X>67)=1-P(X\le 67)\approx 1-`r round(pnorm(67, 62, 4),4)`=0.1056$.
